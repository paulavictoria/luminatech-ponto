...
function PunchClockPage() {
    ...
    const trackItems = [
        { time: '09:30', label: 'Chegada', type: 'start' as const },
        { time: '12:30', label: 'Almoço', type: 'pause' as const },
        { time: '18:30', label: 'Saída', type: 'end' as const },
    ];
    ...
    return (
        <div className={styles.mainContainer}>
            ...
            <ModalPonto show={showModal} onClose={() => setShowModal(false)} />
        </div>
